...
<script type="text/javascript">
    ...
    <script type="text/javascript" src="http://i.s-microsoft.com/en-us/home/script.jsx?k=~/shared/templates/Scripts/picture-polyfill.js&amp;v=2032864016"></script>
    <form name="aspnetForm" method="post" action="/en-us/default.aspx" id="aspnetForm" class="home-form">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwUBMGRkrG4ZZMLmcMpgi9GdziiXK/43OIY=" />

<input type="hidden" name="__EVENTVALIDATION" id="__EVENTVALIDATION" value="/wEWAwKy+5CjCQKQzazvCALixdW5DR3aoGddNUgznGRnKW2jH4+Vzn3u" />
...
<span class="top-bar-storelink " > 
         ...
         <span class="store-editorial" 
           ...
           >  <a href="http://content.microsoftstore.com/home.aspx?WT.mc_id=MSCOM_EN_US_HP_NAV_STORELOC_132M2ENUS35042">Find a Microsoft Store near you</a>
         </span>
...
<div id="ctl00_ctl15_ctl00_ctl00_mscom-search" data-id="#mscom-search" class="mscom-search global-navigation" bi:type="Search">
    <div role="search" class="search-form">
        ...
        <div class="input-wrapper">
            ...
            <input name="q" id="ctl00_ctl15_ctl00_ctl00_q" class="search-box" type="search" autocomplete="off" />
        </div>
        <button type="submit" name="ctl00$ctl15$ctl00$ctl00$searchButton" value="" id="ctl00_ctl15_ctl00_ctl00_searchButton" type="submit" class="search-submit" value="Search"><img src="http://i.s-microsoft.com/global/imagestore/PublishingImages/sprites/search-button-blue.png" alt="Submit" height="16" width="16" /></button>
    </div>
...
<nav id="mscom-navigation" role="navigation" bi:type="menu" class="menu-component">
    <div class="grid-container">
        ...
        <ul role="menubar" class="top-level-menubar">
                    ...
                    <div class="grid-container">
                        <div class="grid-row row-4"><div class="grid-unit list-of-links list-of-links-sm">
                                ...
                                <ul role="menu" bi:parenttitle="t1">
                                    ...
                                    <li role="menuitem"><a bi:index="4" bi:cpid="hpMenu" href="http://www.skype.com/go/skype/?cm_mmc=MSFT|TRAF_B1-_-mscom-hero-us">Skype</a></li>
            ...
            <li role="menuitem" class="top-level-menuitem"><a class="top-level-link" bi:index="2" bi:track="false" bi:titleflag="t1" bi:title="t1" href="">Security</a>
                <div class="dropdown-menu" bi:parenttitle="t1">
                    <div class="grid-container">
            ...
            <li role="menuitem" class="top-level-menuitem"><a class="top-level-link" bi:index="3" bi:track="false" bi:titleflag="t1" bi:title="t1" href="">Support</a>
                <div class="dropdown-menu" bi:parenttitle="t1">
                    <div class="grid-container">
                        <div class="grid-row row-1"><div class="grid-unit list-of-links list-of-links-sm">
            ...
            <li role="menuitem" class="top-level-menuitem"><a class="top-level-link" bi:index="4" bi:track="false" bi:titleflag="t1" bi:title="t1" href="">Store</a>
                <div class="dropdown-menu" bi:parenttitle="t1">
                    <div class="grid-container">
                        <div class="grid-row row-1"><div class="grid-unit list-of-links list-of-links-sm">
...
<div class="heroitem  light-foreground" bi:type="heroitem">
    <div class="media" bi:parenttitle="t1"> 
        <a href="http://clk.atdmt.com/MRT/go/419368222/direct/01/"  bi:track="false" bi:index="0" bi:titleflag="t1"  bi:linkid="F0A-GEN-132F1ENUS31193" bi:cpid="hpFeature">
<div data-picture data-alt="Click in and do more with Surface. Learn more." data-dissable-swap-below >
    <div data-src="http://i.s-microsoft.com/global/ImageStore/publishingimages/FY13/asset/features/Surface_BG_1210_1600x540_EN_US.jpg"></div>
    
    <div data-src="http://i.s-microsoft.com/global/ImageStore/PublishingImages/FY13/Asset/features/Surface_BG_1210_1024x346_EN_US.jpg" data-media="(max-device-pixel-width:1024px)"></div>
    
    <div data-src="http://i.s-microsoft.com/global/ImageStore/PublishingImages/FY13/Asset/features/Surface_BG_1210_600x203_EN_US.jpg" data-media="(max-device-pixel-width:600px)"></div>
    
    <div data-src="http://i.s-microsoft.com/global/ImageStore/PublishingImages/FY13/Asset/features/Surface_BG_1210_480x162_EN_US.jpg" data-media="(max-device-pixel-width:480px)"></div>
    
    <noscript><img src="http://i.s-microsoft.com/global/ImageStore/publishingimages/FY13/asset/features/Surface_BG_1210_1600x540_EN_US.jpg" alt="Click in and do more with Surface. Learn more." /></noscript>
</div>
<script type="text/javascript">window.picturePolyfill.resolveLast();</script>
        </a>
    </div>
...
<div class="text-container">
    <div class="box" style="background: #EC008C; color: #FFFFFF;">
        <img class="box-img" src="http://i.s-microsoft.com/global/ImageStore/publishingimages/logos/hpfeature/hirez/Surface_RetLogo_500x60.png" alt="Surface" bi:type="img" bi:parenttitle="t1" />
        <h3 class="box-title" bi:type="title" bi:title="t1" style="color: #FFFFFF;">Click in and do more. Starting at $499.</h3>
        <ul class="box-actions box-description">
            <li><a bi:index="1" style="color:#FFFFFF;" bi:linkid="F0A-GEN-132F1ENUS31193" bi:cpid="hpFeature" href="http://clk.atdmt.com/MRT/go/419368222/direct/01/">Learn more</a></li>
        </ul>
    </div>
</div>
    </div>
</div>
        </li><li id="slide-2" bi:index="1" selectBi="" style="display: none;">
<div class="heroitem  light-foreground" bi:type="heroitem">
    <div class="media" bi:parenttitle="t1"> 
...
<div data-picture data-alt="Upgrade to Windows 8 Pro for $39.99 ERP and get great app offers." data-dissable-swap-below  data-defer>
...
<div class="text-container">
    <div class="box" style="background: #BA141A; color: #FFFFFF;">
        <img class="box-img" src="http://i.s-microsoft.com/global/ImageStore/publishingimages/logos/hpfeature/hirez/Win8_RetLogo__1127_500x60_EN_US.png" alt="Upgrade to Windows 8 Pro for $39.99 ERP and get great app offers." bi:type="img" bi:parenttitle="t1" />
...
<section class="row-padded">
    ...
    <ul bi:parenttitle="t1">
        ...
        <li><a bi:index="1" bi:linkid="list_discover_item2" href="http://office.microsoft.com/">Office</a>
        </li>
        <li><a bi:index="2" bi:linkid="BNV-00-000000" bi:cpid="hpDiscover" href="http://www.windowsphone.com/">Windows Phone</a>
        </li>
        <li><a bi:index="3" bi:linkid="BNV-00-000000" bi:cpid="hpDiscover" href="http://www.xbox.com/">Xbox</a>
        </li>
        <li><a bi:index="4" bi:linkid="BNV-00-000000" bi:cpid="hpDiscover" href="http://www.skype.com/go/skype/?cm_mmc=MSFT|TRAF_B1-_-mscom-hero-us">Skype</a>
        </li>
    </ul>
</div>
    </div><div class="grid-unit col-3"><div id="pivot-1" class="pivot " bi:type="pivot">
...
<div bi:type="highlight">
    <a href="http://clk.atdmt.com/MRT/go/421231242/direct/01/" bi:linkid="HH1-GEN-132X2ENUS29015" bi:cpid="workHighlight">
        <img  bi:parenttitle="t1" src="http://i.s-microsoft.com/global/ImageStore/publishingimages/FY13/asset/highlights/XboxOffer_1210_420x210_EN_US.jpg" alt="The new entertainment experience from Xbox is here." bi:mimiclink="true" bi:type="img" />
...
<div bi:type="highlight">
    <a href="http://clk.atdmt.com/MRT/go/429148849/direct/01/" bi:linkid="HH2-GEN-132P1ENUS33268" bi:cpid="homeHighlight">
        <img  bi:parenttitle="t1" src="http://i.s-microsoft.com/global/ImageStore/publishingimages/FY13/asset/highlights/WP_Demo_1231_420x210_EN_US.jpg" alt="Test drive Windows Phone, the new phone reinvented around you." bi:mimiclink="true" bi:type="img" />
        <p  bi:parenttitle="t1" bi:mimiclink="true" bi:type="desc">Meet the new phone reinvented around you. Take Windows Phone for a test drive.</p>
        </a>
</div>
    </div><div class="grid-unit">
<div bi:type="highlight">
    <a href="http://clk.atdmt.com/MRT/go/421891233/direct/01/" bi:linkid="HH3-GEN-132O1ENUS29356" bi:cpid="homeHighlight">
        <img  bi:parenttitle="t1" src="http://i.s-microsoft.com/global/ImageStore/publishingimages/FY13/asset/highlights/OfcLaunch_1112_420x210_EN_US.jpg" alt="Limited-time offer: Buy Office now, get the next version free.*" bi:mimiclink="true" bi:type="img" />
        <p  bi:parenttitle="t1" bi:mimiclink="true" bi:type="desc">Limited-time offer: Buy Office now, get the next version free.*</p>
        </a>
</div>
    </div>
...
</div><div id="pivot-2" class="pivot " bi:type="pivot">
...
<div bi:type="highlight">
    <a href="http://clk.atdmt.com/MRT/go/424257189/direct/01/" bi:linkid="HW1-GEN-132C1ENUS34629" bi:cpid="workHighlight">
        <img  bi:parenttitle="t1" src="http://i.s-microsoft.com/global/ImageStore/PublishingImages/FY13/Asset/Highlights/WinSrv_1015_420x210_EN_US.jpg" alt="Windows Server 2012, the first server built from the cloud up." bi:mimiclink="true" bi:type="img" />
        <p  bi:parenttitle="t1" bi:mimiclink="true" bi:type="desc">Insert cloud-grade capabilities into your datacenter with the new Windows Server 2012.</p>
        </a>
</div>
    </div><div class="grid-unit">
<div bi:type="highlight">
    <a href="http://clk.atdmt.com/MRT/go/403778395/direct/01/" bi:linkid="HW2-GEN-131N2ENUS21326" bi:cpid="workHighlight">
        <img  bi:parenttitle="t1" src="http://i.s-microsoft.com/global/ImageStore/PublishingImages/FY13/Asset/Highlights/Intn_0924_420x210_EN_US.jpg" alt="Help manage and secure your PCs and mobile devices with a free trial of Windows Intune." bi:mimiclink="true" bi:type="img" />
        <p  bi:parenttitle="t1" bi:mimiclink="true" bi:type="desc">Help manage and secure PCs and mobile devices with a free trial of Windows Intune.</p>
        </a>
</div>
    </div><div class="grid-unit">
<div bi:type="highlight">
    <a href="http://clk.atdmt.com/MRT/go/403618960/direct/01/" bi:linkid="HW3-GEN-131L1ENUS21309" bi:cpid="workHighlight">
        <img  bi:parenttitle="t1" src="http://i.s-microsoft.com/global/ImageStore/PublishingImages/FY13/Asset/highlights/Of365Try_1001_420x210_EN_US.jpg" alt="Try Office 365 for free for 30 days." bi:mimiclink="true" bi:type="img" />
        <p  bi:parenttitle="t1" bi:mimiclink="true" bi:type="desc">Help your team work together. Try Office 365 free for 30 days.</p>
        </a>
</div>
    </div>
</div><div class="grid-row row-3 "><div class="grid-unit"><div bi:type="list" class="list-of-links list-of-links-med">
    ...
    <ul class="slides">
        <li id="slide-1" bi:index="0" selectBi="">
<div bi:type="highlight">
    <a href="http://blogs.technet.com/b/microsoft_blog/archive/2012/12/12/give-the-gift-of-cool-with-microsoft-this-holiday-season.aspx" bi:linkid="MNC-GEN-000001" bi:cpid="hpNews">
        <img  bi:parenttitle="t1" src="http://i.s-microsoft.com/global//en-us/news/publishingimages/homepage/highlights/event_ConsHoliday_hl.jpg" alt="Got a gift certificate? Get something cool" bi:mimiclink="true" bi:type="img" />
        <h3 class="title" bi:mimiclink="true" bi:title="t1" bi:titleflag="t1" bi:type="title">Got a gift certificate? Get something cool</h3>
        <p  bi:parenttitle="t1" bi:mimiclink="true" bi:type="desc"><time pubdate class="pubdate">Dec. 26, 2012 -</time> See four videos for a range of new hardware devices and software to start 2013 off right.</p>
        </a>
</div>
        </li><li id="slide-2" bi:index="1" selectBi="" style="display: none;">
<div bi:type="highlight">
    <a href="/en-us/news/features/2012/dec12/12-19TwelveHolidayApps.aspx" bi:linkid="MNC-GEN-000002" bi:cpid="hpNews">
        <img  bi:parenttitle="t1" src="http://i.s-microsoft.com/global//en-us/news/publishingimages/homepage/highlights/prod_12Apps_hl.jpg" alt="Great apps for your new Windows 8 device" bi:mimiclink="true" bi:type="img" />
        <h3 class="title" bi:mimiclink="true" bi:title="t1" bi:titleflag="t1" bi:type="title">Great apps for your new Windows 8 device</h3>
        <p  bi:parenttitle="t1" bi:mimiclink="true" bi:type="desc"><time pubdate class="pubdate">Dec. 26, 2012 -</time> Just unwrap a cool new machine? Check out 12 premier apps you can install today.</p>
        </a>
</div>
        </li><li id="slide-3" bi:index="2" selectBi="" style="display: none;">
<div bi:type="highlight">
    <a href="/en-us/news/features/2012/dec12/12-13EOYReview.aspx" bi:linkid="MNC-GEN-000003" bi:cpid="hpNews">
        <img  bi:parenttitle="t1" src="http://i.s-microsoft.com/global/en-us/news/publishingimages/homepage/highlights/event_eoy12_hl.jpg" alt="Video & slideshow: 12 milestones from 2012" bi:mimiclink="true" bi:type="img" />
        <h3 class="title" bi:mimiclink="true" bi:title="t1" bi:titleflag="t1" bi:type="title">Video &amp; slideshow: 12 milestones from 2012</h3>
        <p  bi:parenttitle="t1" bi:mimiclink="true" bi:type="desc"><time pubdate class="pubdate">Dec. 13, 2012 -</time> As 2012 winds down, take a look at how Microsoft has built its devices and services foundation for the year ahead.</p>
        </a>
</div>
        </li>
    </ul>
...
<div id="ctl00_ctl17_subLayout1_ctl04_ctl00_mscom-search" data-id="#mscom-search" class="mscom-search global-navigation" bi:type="Search">
    <div role="search" class="search-form">
        ...
        <div class="input-wrapper">
            ...
            <input name="q" id="ctl00_ctl17_subLayout1_ctl04_ctl00_q" class="search-box" type="search" autocomplete="off" />
        </div>
        <button type="submit" name="ctl00$ctl17$subLayout1$ctl04$ctl00$searchButton" value="" id="ctl00_ctl17_subLayout1_ctl04_ctl00_searchButton" type="submit" class="search-submit" value="Search"><img src="http://i.s-microsoft.com/global/imagestore/PublishingImages/sprites/search-button-blue.png" alt="Submit" height="16" width="16" /></button>
    </div>
    <div class="search-results-box">
        <div bi:track="false" class="search-results">
            <ul>
    ...
    <ul bi:parenttitle="t1">
        <li><a bi:index="0" bi:linkid="PTN-00-000000" bi:cpid="hpFatFooter" href="http://windows.microsoft.com"><img src="http://i.s-microsoft.com/global/ImageStore/PublishingImages/logos/52x52/windows_symbol_clr_52x52.png" alt=""/>Windows</a>
        </li>
        <li><a bi:index="1" bi:linkid="PTN-00-000000" bi:cpid="hpFatFooter" href="http://office.microsoft.com/"><img src="http://i.s-microsoft.com/global/ImageStore/PublishingImages/logos/52x52/office_symbol_clr_52x52.png" alt=""/>Office</a>
        </li>
        <li><a bi:index="2" bi:linkid="PTN-00-132F1ENUS32267" bi:cpid="hpFatFooter" href="http://clk.atdmt.com/MRT/go/420109147/direct/01/"><img src="http://i.s-microsoft.com/global/ImageStore/PublishingImages/logos/52x52/fallpromo_bug_black.png" alt=""/>Surface</a>
        </li>
        <li><a bi:index="3" bi:linkid="PTN-00-000000" bi:cpid="hpFatFooter" href="http://www.windowsphone.com/"><img src="http://i.s-microsoft.com/global/ImageStore/PublishingImages/logos/52x52/windowsphone_symbol_clr_52x52.png" alt=""/>Windows Phone</a>
        </li>
        <li><a bi:index="4" bi:linkid="PTN-00-000000" bi:cpid="hpFatFooter" href="http://www.xbox.com/"><img src="http://i.s-microsoft.com/global/ImageStore/PublishingImages/logos/52x52/xbox_symbol_clr_52x52.png" alt=""/>Xbox</a>
        </li>
        <li><a bi:index="5" bi:linkid="PTN-00-000000" bi:cpid="hpFatFooter" href="http://www.skype.com/go/skype/?cm_mmc=MSFT|TRAF_B1-_-mscom-hero-us"><img src="http://i.s-microsoft.com/global/ImageStore/PublishingImages/logos/52x52/skype_symbol_clr_52x52.png" alt=""/>Skype</a>
        </li>
        <li><a bi:index="6" bi:linkid="PTN-00-000000" bi:cpid="hpFatFooter" href="http://www.bing.com/"><img src="http://i.s-microsoft.com/global/ImageStore/PublishingImages/logos/52x52/bing_symbol_clr_52x52.png" alt=""/>Bing</a>
        </li>
        <li><a bi:index="7" bi:linkid="PTN-00-000000" bi:cpid="hpFatFooter" href="http://www.microsoftstore.com/store/msstore/home?WT.mc_id=MSCOM_HP_footer"><img src="http://i.s-microsoft.com/global/ImageStore/PublishingImages/logos/52x52/store_symbol_clr_52x52.png" alt=""/>Microsoft Store</a>
        </li>
    </ul>
</div>
    ...
    <div class="legal grid-container">
        <div class="grid-row row-4">
            <div class="grid-unit col-1" bi:type="locale">
                <span class="icon-globe"></span><a href="/en-us/home/locale.aspx">United States - English</a>
            </div>
    ...
    <script type="text/javascript" src="http://i.s-microsoft.com/en-us/home/script.jsx?k=~/shared/templates/Scripts/jquery.responsiveslideshow.js;~/shared/templates/Scripts/mscomhelper.js;~/shared/templates/Scripts/search.js;~/shared/templates/Scripts/mscom-homepage.js;~/shared/templates/Scripts/feedback.js;~/shared/templates/Scripts/_menu.js;~/shared/templates/Scripts/_hero.js&amp;v=1179292932"></script>
    ...
    <noscript><img alt="" width="1" height="1" src="http://c.microsoft.com/trans_pixel.aspx"/></noscript><script type="text/javascript" src="http://i.s-microsoft.com/en-us/home/script.jsx?k=~/shared/templates/Scripts/jquery.bi.js;~/shared/templates/Scripts/jquery.bi.dataretrievers.attr.js;~/shared/templates/Scripts/jquery.bi.dataretrievers.structure.js;~/shared/templates/Scripts/jquery.bi.dataretrievers.resp.js;~/shared/templates/Scripts/wedcs.js;~/shared/templates/Scripts/jquery.bi.dataconsumers.wedcs.js;~/shared/templates/Scripts/webtrends.js;~/shared/templates/Scripts/jquery.bi.dataconsumers.webtrends.js&amp;v=-653219180"></script>
    


<script src="http://i.s-microsoft.com/en-us/home/bimapping.js?gv=BiMapping&amp;k=/en-us/home/Components/Config/BiMapping.xml&amp;v=-1066748564" type="text/javascript"></script>
<script type="text/javascript">
...
<script type="text/javascript">window.requestId='c0fb151e-c214-4990-815f-8f9ec25e7bea';</script>
</body>
</html>
